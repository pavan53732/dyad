...
interface SourceConnector {
  ...
  findSimilar?(entity: UnifiedKnowledgeEntity, options?): Promise<UnifiedKnowledgeEntity[]>;
...
*Evolution Cycle 2 completed successfully. Source connectors are now wired to actual modules, enabling real cross-source knowledge queries.*
