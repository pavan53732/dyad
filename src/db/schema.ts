...
export const knowledgeNodes = sqliteTable(
  ...
  (table) => [
    unique("uniq_knowledge_node_app_name_type").on(
      table.appId,
      table.name,
      table.type,
      table.filePath,
...
export const plans = sqliteTable("plans", {
  ...
  goalIds: text("goal_ids", { mode: "json" })
    .$type<string[]>()
    .notNull()
    .default("[]"),
...
export const scheduleEntries = sqliteTable("schedule_entries", {
  ...
  dependsOn: text("depends_on", { mode: "json" })
    ...
    .notNull()
    .default("[]"),
  requiredResources: text("required_resources", { mode: "json" }).$type<
    Array<{
      type: string;
      amount: number;
 ...
 */
export const scheduleQueues = sqliteTable("schedule_queues", {
  id: text("id").primaryKey(),
  appId: integer("app_id")
    .notNull()
    .references(() => apps.id, { onDelete: "cascade" }),
  ...
  pendingEntries: text("pending_entries", { mode: "json" })
    .$type<string[]>()
    .notNull()
    .default("[]"),
  priorityOrder: text("priority_order", { mode: "json" })
    .$type<string[]>()
    .notNull()
    .default("[]"),
 ...
 */
export const distributedAgents = sqliteTable("distributed_agents", {
  id: text("id").primaryKey(),
  name: text("name").notNull(),
 ...
 */
export const distributedNodes = sqliteTable("distributed_nodes", {
  id: text("id").primaryKey(),
  name: text("name").notNull(),
...
export const distributedAgentsRelations = relations(
  distributedAgents,
  ({ one }) => ({
    app: one(apps, {
...
export const agentCheckpointsRelations = relations(
  agentCheckpoints,
  ({ one }) => ({
...
export const architectureDecisions = sqliteTable("architecture_decisions", {
  ...
  relatedEntities: text("related_entities", { mode: "json" })
    ...
    .notNull()
    .default("[]"),
  lessonsLearned: text("lessons_learned", { mode: "json" })
    .$type<string[]>()
    .notNull()
    .default("[]"),
  createdBy: text("created_by"),
 ...
 */
export const knowledgeQueries = sqliteTable("knowledge_queries", {
  id: text("id").primaryKey(),
  appId: integer("app_id")
    .notNull()
    .references(() => apps.id, { onDelete: "cascade" }),
  ...
  sources: text("sources", { mode: "json" })
    ...
    .notNull()
    .default("[]"),
  entityTypes: text("entity_types", { mode: "json" })
    .$type<string[]>()
    .notNull()
    .default("[]"),
...
export const learnedPatterns = sqliteTable("learned_patterns", {
  ...
  basedOnDecisionId: text("based_on_decision_id").references(
    () => architectureDecisions.id,
    { onDelete: "set null" },
  ),
...
export const knowledgeRelationships = sqliteTable(
  ...
  (table) => [
    unique("uniq_knowledge_relationship").on(
...
export const architectureDecisionsRelations = relations(
...
export const knowledgeQueriesRelations = relations(
  knowledgeQueries,
  ({ one }) => ({
    app: one(apps, {
...
export const learnedPatternsRelations = relations(
  learnedPatterns,
  ({ one }) => ({
    app: one(apps, {
